...
{
 "use strict";
 var Global,Cookbook,Client,WebSharper,UI,Var$1,Submitter,View,Remoting,AjaxRemotingProvider,Concurrency,Doc,AttrProxy;
 Global=self;
 Cookbook=Global.Cookbook=Global.Cookbook||{};
 Client=Cookbook.Client=Cookbook.Client||{};
 ...
 Client.Main=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("Cookbook:Cookbook.Server.DoSomething:1024021089",[a.$0]):(b=null,Concurrency.Delay(function()
   {
